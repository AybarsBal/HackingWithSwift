...
class ViewController: UITableViewController, UIWindowSceneDelegate {
    
    var projects = [Project]() // Challenge 1
    var favorites = [Int]()
    ...
    override func viewDidLoad() {
        ...
        notificationCenter.addObserver(self, selector: #selector(adjustSize), name: UIContentSizeCategory.didChangeNotification, object: nil)
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.attributedText = makeAttributedString(title: project.title, subtitle: project.subtitle) // Challenge 1
    ...
    func makeAttributedString(title: String, subtitle: String) -> NSAttributedString {
        let titleAttributes = [NSAttributedString.Key.font: UIFont.preferredFont(forTextStyle: .headline), NSAttributedString.Key.foregroundColor: UIColor.purple, NSAttributedString.Key.underlineColor: UIColor.purple, NSAttributedString.Key.underlineStyle: NSUnderlineStyle.single.rawValue] as [NSAttributedString.Key : Any] // Challenge 2
